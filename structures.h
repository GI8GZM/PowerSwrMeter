...
frame civFrame[] = {
  ...
  { 200, 25,	90, 40,		BG_COLOUR,		true,	false,	false},		// 11 - samplesDefault (averaging samples - default)
  { 200, 70,	90, 40,		BG_COLOUR,		true,	false,	false},		// 12 - samplesAltOpt	(averaging samples - alternate)
  { 200, 115,	90, 40,		BG_COLOUR,		true,	false,	false},		// 13 - samplesCalOpt	(averaging samples - calibrate mode)
  { 200, 160,	90, 40,		BG_COLOUR,		true,	false,	false},		// 14 -  weighting for expnential smoothing  
